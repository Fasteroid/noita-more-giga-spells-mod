...
local function AddLaserEmitter(entity_id, angle)
    ...
    ComponentObjectSetValue2(laser_comp, "laser", "damage_to_entities",                    0.12           )
    ComponentObjectSetValue2(laser_comp, "laser", "max_cell_durability_to_destroy",        14             )
    ComponentObjectSetValue2(laser_comp, "laser", "damage_to_cells",                       500            )
    ...
    ComponentObjectSetValue2(laser_comp, "laser", "hit_particle_chance",                   20             )
